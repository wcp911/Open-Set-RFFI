...
if __name__ == '__main__':
    ...
    for j in range(len(train_list)):
        ...
        for i in range(len(splits[options['dataset']])):
            ...
            result_model_path = './log/MSP/' + options['model_name'] + '/' + options['dataset'] + '/' + str(current_time) + '/result_model'
            confusion_matrix_path = './log/MSP/'+ options['model_name'] + '/'+ options['dataset'] + '/' + str(current_time) + '/confusion_matrix'
            log_path = './log/MSP/'+ options['model_name'] + '/'+ options['dataset'] + '/' + str(current_time)
            options.update(
                {
